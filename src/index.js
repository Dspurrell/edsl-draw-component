...
class App extends React.Component {
    ...
    constructor () {
        ...
        CreateDraw() {
            ...
            // console.log("this is the new array", roundsArray);
            // console.log("this is the draw array", this.state.draw);
    ...
    render() {
        ...
        return (
            <div>
                <button onClick = {this.CreateDraw.bind(this)}>CreateDraw</button>
                <table>
                    <tbody>
                    <tr>
                        <th>Round</th>
